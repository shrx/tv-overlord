...
if __name__ == '__main__':
	...
	tbl.header_item (text='dog', width=20, justification='right')
	tbl.header_item (text='cat', width=0, justification='left')
	tbl.header_item (text='horse', width=20)
	tbl.header_item (text='water buffalo', width=20, justification='left')
