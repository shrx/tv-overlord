...
TV Downloader requires five additional python libraries (not part of
...
Note: install python-dateutil
Traceback (most recent call last):
  File "./tv.py", line 48, in <module>
...
*** Install steps
  ...
  6. Create a dir somewhere and clone this repository: \\
     =git clone https://github.com/smmcg/tv-downloader.git=
  7. Put the dir on your $PATH or symlink tv.py to a dir that is
     on the path.
  ...
  9. Type =tv.py addnew "someshow";= to start. \\
